angular.module('templates-prod', ['/components/admin/bpmn_manager.html', '/components/auth/login.html', '/components/bapComponents/dashboard.html', '/components/bapComponents/left-menu.html', '/components/bapComponents/top-action-buttons.html', '/components/crud/templates/crud-preload.html', '/components/crud/templates/crud.html', '/components/crud/templates/filter.html', '/components/crud/templates/form.html', '/components/crud/templates/inline_edit.html', '/components/crud/templates/list.html', '/components/crud/templates/nodeTable.html', '/components/crud/templates/quick_add.html', '/components/crud/templates/show.html', '/components/crud/templates/timetable.html', '/components/dashboard/dashboard.html', '/components/dashboard/directives/academic-calendar.html', '/components/dashboard/directives/calendar-popover.html', '/components/dashboard/directives/custom-grid-filter.html', '/components/dashboard/directives/dashboard-tables.html', '/components/dashboard/directives/empty-task.html', '/components/dashboard/directives/single-task.html', '/components/dashboard/directives/user-tasks.html', '/components/dashboard/directives/zeta-grid.html', '/components/dashboard/user-info.html', '/components/dashboard/user-templates/academician.html', '/components/dashboard/user-templates/staff.html', '/components/dashboard/user-templates/student.html', '/components/debug/debug.html', '/components/devSettings/devSettings.html', '/components/error_pages/404.html', '/components/error_pages/500.html', '/components/gridTable/gridreport.html', '/components/messaging/templates/add_user_unit.html', '/components/messaging/templates/conversation.html', '/components/messaging/templates/create_channel.html', '/components/messaging/templates/delete_confirmation.html', '/components/messaging/templates/edit_message.html', '/components/messaging/templates/index.html', '/components/messaging/templates/search_user.html', '/components/uitemplates/404.html', '/components/uitemplates/500.html', '/components/uitemplates/academician.html', '/components/uitemplates/base.html', '/components/uitemplates/form_service_pg.html', '/components/uitemplates/staff.html', '/components/uitemplates/student.html', '/components/zetaGanttChart/zeta-gantt-chart.html', '/shared/templates/actionsModalContent.html', '/shared/templates/add.html', '/shared/templates/confirm.html', '/shared/templates/confirmModalContent.html', '/shared/templates/confirmprev.html', '/shared/templates/datefield.html', '/shared/templates/demoMode.html', '/shared/templates/directives/alert.html', '/shared/templates/directives/chat.html', '/shared/templates/directives/guide-help.html', '/shared/templates/directives/header-breadcrumb.html', '/shared/templates/directives/header-notification.html', '/shared/templates/directives/header-sub-menu.html', '/shared/templates/directives/header-user-menu.html', '/shared/templates/directives/messaging/detail.html', '/shared/templates/directives/messaging/index.html', '/shared/templates/directives/msgbox.html', '/shared/templates/directives/notifications.html', '/shared/templates/directives/right-sidebar.html', '/shared/templates/directives/search.html', '/shared/templates/directives/selected-user.html', '/shared/templates/directives/selectedUserPopover.html', '/shared/templates/directives/sidebar-search.html', '/shared/templates/directives/sidebar.html', '/shared/templates/directives/sort.html', '/shared/templates/directives/stats.html', '/shared/templates/directives/timeline.html', '/shared/templates/directives/timetable-action-selector.html', '/shared/templates/directives/user-info.html', '/shared/templates/fieldset.html', '/shared/templates/filefield.html', '/shared/templates/foreignKey.html', '/shared/templates/linkedModelModalContent.html', '/shared/templates/listnodeModalContent.html', '/shared/templates/modalContent.html', '/shared/templates/multiselect.html', '/shared/templates/notificationsModalContent.html', '/shared/templates/select.html', '/shared/templates/translate.html', '/shared/templates/typeahead.html']);
...
angular.module("/components/auth/login.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("/components/auth/login.html",
    "<div style=\"width: 100%; height: 100%; position: fixed; z-index: 1100; top:0; left:0; right: 0; bottom: 0; background: #A61229;\">\n" +
    "    <demo-mode></demo-mode>\n" +
    "    <msgbox ng-show=\"msgbox\"></msgbox>\n" +
    "    <div class=\"login-wrapper\">\n" +
    "        <div ng-app=\"ulakbus.auth\" class=\"login\">\n" +
    "            <div class=\"logo\" title=\"Ulakbus\"><img src=\"/img/brand-logo2.png\" alt=\"Ulakbüs\"></div>\n" +
...
angular.module("/components/crud/templates/crud.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("/components/crud/templates/crud.html",
    ...
    "        <msgbox ng-show=\"msgbox\"></msgbox>\n" +
    "        <h3 ng-class=\"{'mid-h3': !objects}\">{{ object_title || schema.title}}</h3>\n" +
    "        <zeta-gantt-chart ng-if=\"gantt_chart\" gantt-chart-data=\"gantt_chart\"></zeta-gantt-chart>\n" +
    ...
    "        <zeta-grid ng-if=\"gridOptions\" grid-options-provided=\"gridOptions\" token=\"token\" wf=\"wf\"></zeta-grid>\n" +
    "    </div>\n" +
...
angular.module("/components/crud/templates/nodeTable.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("/components/crud/templates/nodeTable.html",
    ...
    "            ng-class=\"{'ddlWidth': node.schema.properties[k].type === 'select'}\">\n" +
...
angular.module("/components/crud/templates/show.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("/components/crud/templates/show.html",
    "<div class=\"starter-template form-container\">\n" +
    "    <div ng-repeat=\"obj in object\" class=\"detail-page\">\n" +
    "        <div class=\"info-block-header\" ng-if=\"obj.title\">\n" +
    "            <h3>{{obj.title}}</h3>\n" +
    "        </div>\n" +
...
angular.module("/components/dashboard/dashboard.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("/components/dashboard/dashboard.html",
    ...
    "\n" +
    "<!--        <div class=\"row\">\n" +
    "        	<div class=\"col-sm-12 generic-search\">\n" +
    "            	<div class=\"panel panel-default\">\n" +
    "                	<div class=\"search-box-wrapper\">\n" +
    "                    	<span class=\"glyphicon glyphicon-search\"></span>\n" +
    "                    	<input type=\"text\" placeholder=\"Search\">\n" +
    "                    </div>\n" +
    "                    &lt;!&ndash; end of search-box-wrapper &ndash;&gt;\n" +
    "                    <div class=\"search-results\">\n" +
    "                    	<ul>\n" +
    "                        	<li class=\"result-box\">\n" +
    "                            	<a class=\"clearfix\">\n" +
    "                            		<div class=\"pull-left\"><img src=\"../../img/sample-profile-pic.jpg\" class=\"profile-pic\"></div>\n" +
    "                                    <div class=\"pull-left user-info\">\n" +
    "                                    	<div class=\"name\">James Bolton<span uib-tooltip=\"Student No\" tooltip-placement=\"right\">1807452</span></div>\n" +
    "                                        <div class=\"unit\"><span>Eğitim Fakültesi</span> / Bilgisayar ve Öğretim Teknolojileri Eğitimi Bölümü</div>\n" +
    "                                        <div class=\"number\"><span>TC. NO:</span> 01454197872</div>\n" +
    "                                    </div>\n" +
    "                            	</a>\n" +
    "                            </li>\n" +
    "                            &lt;!&ndash; end of result-box &ndash;&gt;\n" +
    "                            <li class=\"result-box\">\n" +
    "                            	<a class=\"clearfix\">\n" +
    "                            		<div class=\"pull-left\"><img src=\"../../img/sibel.jpg\" class=\"profile-pic\"></div>\n" +
    "                                    <div class=\"pull-left user-info\">\n" +
    "                                    	<div class=\"name\">Sibel Demir<span uib-tooltip=\"Sicil No\" tooltip-placement=\"right\">135649849</span></div>\n" +
    "                                        <div class=\"unit\"><span>Personel İşleri Dairesi</span></div>\n" +
    "                                        <div class=\"number\"><span>TC. NO:</span> 25458287992</div>\n" +
    "                                    </div>\n" +
    "                            	</a>\n" +
    "                            </li>\n" +
    "                            &lt;!&ndash; end of result-box &ndash;&gt;\n" +
    "                            <li class=\"result-box\">\n" +
    "                            	<a class=\"clearfix\">\n" +
    "                            		<div class=\"pull-left\"><img src=\"../../img/empty-profile-pic.jpg\" class=\"profile-pic\"></div>\n" +
    "                                    <div class=\"pull-left user-info\">\n" +
    "                                    	<div class=\"name\">Scott Furry<span uib-tooltip=\"Student No\" tooltip-placement=\"right\">6549814</span></div>\n" +
    "                                        <div class=\"unit\"><span>Mühendislik Fakültesi</span>/Bilgisayar Mühendisliği</div>\n" +
    "                                        <div class=\"number\"><span>TC. NO:</span> 45879852021</div>\n" +
    "                                    </div>\n" +
    "                            	</a>\n" +
    "                            </li>\n" +
    "                            &lt;!&ndash; end of result-box &ndash;&gt;\n" +
    "                        </ul>\n" +
    "                    </div>\n" +
    "                    &lt;!&ndash; end of search-results &ndash;&gt;\n" +
    "                </div>\n" +
    "                &lt;!&ndash; end of panel &ndash;&gt;\n" +
    "            </div>\n" +
    "            &lt;!&ndash; end of generic-search &ndash;&gt;\n" +
    "        </div>-->\n" +
    "\n" +
    "        <!-- end of row -->\n" +
    "\n" +
    "        <!-- STUDENT ASSIGNMENTS -->\n" +
    "        <div class=\"row\">\n" +
    "            <user-tasks class=\"col-sm-12\"></user-tasks>\n" +
    ...
    "        <!-- DASHBOARD TABLES -->\n" +
    "        <div class=\"row\">\n" +
    "            <dashboard-tables class=\"col-sm-12\"></dashboard-tables>\n" +
    "        </div>\n" +
    "        <!-- end of row -->\n" +
    "    </div>\n" +
    "</div>\n" +
...
angular.module("/components/dashboard/directives/custom-grid-filter.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("/components/dashboard/directives/custom-grid-filter.html",
    "<div>\n" +
    "  <select>\n" +
...
angular.module("/components/dashboard/directives/dashboard-tables.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("/components/dashboard/directives/dashboard-tables.html",
    "<div class=\"table-responsive\" ng-repeat=\"table in tables\">\n" +
    "  <h4>{{table.title}}</h4>            \n" +
    "  <table class=\"table table-bordered  table-striped\">\n" +
    "    <tbody>\n" +
    "      <tr ng-repeat=\"row in table.rows\">\n" +
    "        <th ng-repeat=\"col in row.cols\">{{col.content}}</th>\n" +
    "      </tr>\n" +
    "    </tbody>\n" +
    "  </table>\n" +
    "</div>");
...
angular.module("/components/dashboard/directives/empty-task.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("/components/dashboard/directives/empty-task.html",
    "<div class=\"no-task text-center\" >\n" +
    "    {{taskType}} görev bulunamadı.\n" +
    "</div>");
}]);

angular.module("/components/dashboard/directives/single-task.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("/components/dashboard/directives/single-task.html",
    "<li class=\"{{task_class}}\">\n" +
    "    <div class=\"task-actions-wrapper\" ng-click=\"getActions()\" uib-dropdown dropdown-append-to-body>\n" +
    "        <div class=\"task-actions\" uib-dropdown-toggle>\n" +
    "            <div class=\"icon-wrapper\">\n" +
    "                <span class=\"glyphicon glyphicon-option-vertical\"></span>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <ul class=\"task-manager-dropdown dropdown-menu\" uib-dropdown-menu role=\"menu\" aria-labelledby=\"btn-append-to-body\">\n" +
    "            <li ng-repeat=\"action in actions\"><a ng-href=\"{{action.link}}\">{{action.title}}</a></li>\n" +
    "        </ul>\n" +
    "    </div>\n" +
    "    <a ng-href=\"{{link}}\" class=\"clearfix\">\n" +
    "        <span class=\"task-status\">\n" +
    "            <div class=\"task-circle\" uib-tooltip=\"{{task_tooltip}}\" tooltip-placement=\"right\"></div>\n" +
    "            <img ng-if=\"task.status == false\" src=\"../../img/task-manager-icons/unclaimed.png\" uib-tooltip=\"Sahipsiz\" tooltip-placement=\"right\">\n" +
    "            <img ng-if=\"task.state == 20\" src=\"../../img/task-manager-icons/in-progress.png\" uib-tooltip=\"İlerleme Halinde\" tooltip-placement=\"right\">\n" +
    "            <img ng-if=\"task.state == 30\" src=\"../../img/task-manager-icons/waiting.png\" uib-tooltip=\"Tamamlanmayı Bekliyor\" tooltip-placement=\"right\">\n" +
    "        </span>\n" +
    "        <span class=\"task-title\">\n" +
    "            <div ng-bind=\"task.title\"></div>\n" +
    "            <div ng-bind=\"task.description || '&nbsp;' \"></div>\n" +
    "            <div ng-bind=\"task_date\"></div>\n" +
    "        </span>\n" +
    "    </a>\n" +
    "\n" +
    "\n" +
...
angular.module("/components/dashboard/directives/user-tasks.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("/components/dashboard/directives/user-tasks.html",
    ...
    "            <div class=\"panel-title col-md-3\">Görev Yöneticisi</div>\n" +
    "            <div class=\"col-md-9 row\">\n" +
    "                <div class=\"col-md-3\">\n" +
    "                    <select class=\"form-control\" ng-change=\"taskTypeChange()\" ng-model=\"taskType\" ng-options=\"item.name as item.title for item in taskTypes\"></select>\n" +
    "                </div>\n" +
    "                <div class=\"col-md-3\">\n" +
    "                    <select class=\"form-control\" ng-change=\"taskTimeChange()\" ng-model=\"taskTime\" ng-options=\"item.name as item.title for item in taskTimes\"></select>\n" +
    "                </div>\n" +
    "                <div class=\"task-manager-search col-md-6\">\n" +
    "                    <span class=\"glyphicon glyphicon-search\"></span>\n" +
    "                    <input class=\"form-control\" type=\"text\" ng-change=\"taskSearch()\" ng-model=\"taskManagerSearchQuery\" placeholder=\"Görev yöneticisi içinde ara\">\n" +
    "                </div>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"panel-body\">\n" +
    ...
    "                <li role=\"presentation\" class=\"active\"><a ng-click=\"tab('active')\" href=\".current-tasks\" aria-controls=\"current-tasks\" role=\"tab\" data-toggle=\"tab\">Aktif Görevler <span>{{task_count.active || 0}}</span></a></li>\n" +
    "                <li role=\"presentation\"><a ng-click=\"tab('future')\" href=\".future-tasks\" aria-controls=\"future-tasks\" role=\"tab\" data-toggle=\"tab\">Gelecekteki Görevler <span>{{task_count.future||0}}</span></a></li>\n" +
    "                <li role=\"presentation\"><a ng-click=\"tab('finished')\" href=\".finished-tasks\" aria-controls=\"finished-tasks\" role=\"tab\" data-toggle=\"tab\">Tamamlanan Görevler <span>{{task_count.finished||0}}</span></a></li>\n" +
    "                <li role=\"presentation\"><a ng-click=\"tab('expired')\" href=\".expired-tasks\" aria-controls=\"expired-tasks\" role=\"tab\" data-toggle=\"tab\">Geçersiz Görevler <span>{{task_count.expired||0}}</span></a></li>\n" +
    "            </ul>\n" +
    "            <!-- Tab panes -->\n" +
    "            <div class=\"tab-content\">\n" +
    "                <div role=\"tabpanel\" class=\"tab-pane current-tasks active\">\n" +
    "                    <ul>\n" +
    "                        <single-task ng-repeat=\"(key, value) in task_list.current.data\" key={{key}}></single-task>\n" +
    "                        <empty-task tasktype=\"Aktif\" ng-if=\"task_list.current.isEmpty\"></empty-task>\n" +
    "                    </ul>\n" +
    "                </div>\n" +
    "                <div role=\"tabpanel\" class=\"tab-pane future-tasks\">\n" +
    "                    <ul>\n" +
    "                        <single-task ng-repeat=\"(key, value) in task_list.future.data\" data={{task}}></single-task>\n" +
    "                        <empty-task tasktype=\"Gelecek\" ng-if=\"task_list.future.isEmpty\"></empty-task>\n" +
    "                    </ul>\n" +
    "                </div>\n" +
    "                <div role=\"tabpanel\" class=\"tab-pane finished-tasks\">\n" +
    "                    <ul>\n" +
    "                        <single-task ng-repeat=\"(key, value)  in task_list.finished.data\" data={{task}}></single-task>\n" +
    "                        <empty-task tasktype=\"Tamamlanmış\" ng-if=\"task_list.finished.isEmpty\"></empty-task>\n" +
    "                    </ul>\n" +
    "                </div>\n" +
    "                <div role=\"tabpanel\" class=\"tab-pane expired-tasks\">\n" +
    "                    <ul>\n" +
    "                        <single-task ng-repeat=\"(key, value)  in task_list.expired.data\" data={{task}}></single-task>\n" +
    "                        <empty-task tasktype=\"Geçersiz\" ng-if=\"task_list.expired.isEmpty\"></empty-task>\n" +
    "                    </ul>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "        </div>\n" +
...
angular.module("/components/dashboard/directives/zeta-grid.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("/components/dashboard/directives/zeta-grid.html",
    "<div ng-show=\"gridOptions\">\n" +
    "    <h4 style=\"padding-bottom: 15px;\">{{ pageTitleText }}\n" +
    "        <span class=\"loader\" ng-show=\"loadingChannel\" style=\"float: right;\"></span>\n" +
    "        <span style=\"float: right; color: #A61229;\"\n" +
    "              ng-show=\"loadingChannel\"><i>{{ dataLoadingText }}</i></span>\n" +
    "    </h4>\n" +
    "    <div>\n" +
    "        <div>\n" +
    "            <button class=\"btn-grid-generic\" ng-click=\"applyFilter()\" ng-disabled=\"loadingChannel\">{{ applyFilterText }}</button>\n" +
    "            <button class=\"btn-grid-generic\" ng-click=\"clearFilter()\" ng-disabled=\"loadingChannel\">{{ cancelFilterText }}</button>\n" +
    "            <button class=\"btn-grid-generic\" ng-click=\"toggleColumnSelector()\" ng-disabled=\"loadingChannel\">{{ selectColumnsText }}</button>\n" +
    "            <button class=\"btn-grid-generic\" ng-click=\"downloadCsv()\" style=\"float: right;\" ng-disabled=\"loadingChannel\">{{ csvDownloadText }}</button>\n" +
    "        </div>\n" +
    "\n" +
    "        <div ng-show=\"showColumnSelector\">\n" +
    "            <span>Izgarada görmek istediğiniz sütunları seçin</span>\n" +
    "            <ul style=\"\n" +
    "                        margin-top: 10px;\n" +
    "                        list-style: none;\n" +
    "                        max-height: 150px;\n" +
    ...
    "                        overflow-x: hidden;\n" +
    "                    \">\n" +
    "                <li style=\" display: inline-block; width: 33%;\" ng-repeat=\"selector in grid.selectors\">\n" +
    "                    <label for=\"{{ selector.label }}\">{{selector.label}}</label>\n" +
    "                    <input id=\"{{ selector.label }}\" type=\"checkbox\" ng-checked=\"selector.checked\" ng-model=\"selector.checked\"/>\n" +
    "                </li>\n" +
    "            </ul>\n" +
    "            <button class=\"btn-grid-generic\" class=\"default\" ng-click=\"submitSelectors()\" ng-disabled=\"loadingChannel\">\n" +
    "                Gönder\n" +
    "            </button>\n" +
    "        </div>\n" +
    "        <div id=\"zeta-grid\" class=\"grid\" ui-grid=\"gridOptions\" ui-grid-infinite-scroll ui-grid-auto-resize style=\"height:480px;\"></div>\n" +
    "    </div>\n" +
    "</div>\n" +
    "");
}]);
...
angular.module("/components/dashboard/user-templates/staff.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("/components/dashboard/user-templates/staff.html",
    ...
    "<!--TODO-->\n" +
    "                        <!--<div>\n" +
    "                            <label for=\"\" style=\"margin-left:52px;margin-top:10px;display:block\">\n" +
    "                                <input id=\"\" ng-model=\"\" ng-change=\"\" type=\"checkbox\" ng-checked=\"\" style=\"width:15px\"> \n" +
    "                                <span style=\"margin-left:10px\">text 1</span> \n" +
    "                            </label>\n" +
    "                            <label for=\"\" style=\"margin-left:52px;margin-top:10px;display:block\">\n" +
    "                                <input id=\"\" ng-model=\"\" ng-change=\"\" type=\"checkbox\" ng-checked=\"\" style=\"width:15px\"> \n" +
    "                                <span style=\"margin-left:10px\">text 2</span> \n" +
    "                            </label>\n" +
    "                            <label for=\"\" style=\"margin-left:52px;margin-top:10px;display:block\">\n" +
    "                                <input id=\"\" ng-model=\"\" ng-change=\"\" type=\"checkbox\" ng-checked=\"\" style=\"width:15px\"> \n" +
    "                                <span style=\"margin-left:10px\">text 3</span> \n" +
    "                            </label>\n" +
    "                        </div>-->\n" +
    "<!--TODO-->\n" +
    ...
    "                        </div>\n" +
    "\n" +
    "                        <div class=\"personal-area-filter\">\n" +
    "                            <label for=\"personal-area-filter\" ng-repeat=\"checkbox in personelAra.checkboxes\">\n" +
    "                                <input name=\"personal-area-filter\" ng-model=\"checkbox.checked\" type=\"checkbox\" ng-checked=\"checkbox.checked\"> \n" +
    ...
    "<div class=\"row\">\n" +
    "\n" +
    "    <div class=\"col-md-12 quick-links\" style=\"display:none\">\n" +
    "        <div class=\"panel panel-default\">\n" +
    "            <div class=\"panel-heading\">\n" +
    ...
    "<!-- end of row -->\n" +
    "\n" +
    "<div class=\"dashboard-main-anouncement clearfix\" style=\"display:none\"> \n" +
    "\n" +
    "    <div class=\"row\">\n" +
    "        <div class=\"col-md-12\">\n" +
    "            <div class=\"panel panel-default\">\n" +
...
angular.module("/components/gridTable/gridreport.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("/components/gridTable/gridreport.html",
    "<div>\n" +
    "    <zeta-grid></zeta-grid>\n" +
    "</div>\n" +
    "");
...
angular.module("/components/zetaGanttChart/zeta-gantt-chart.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("/components/zetaGanttChart/zeta-gantt-chart.html",
    "<div class=\"form-container\">\n" +
    "    <div gantt data=\"data\" options=\"options\" max-height=\"options.maxHeight\" view-scale=\"options.viewScale\" class=\"zeta-gantt\" ng-show=\"showGanttChart\">\n" +
